...
CREATE TABLE `wp_product` (
  ...
  `symbol_currency` varchar(5) DEFAULT NULL,
...
INSERT INTO `wp_product` VALUES (3,3,'Jabon','De baño','2018-05-05 00:00:00',1500,1,'Peso colombiano','$','COP'),(4,4,'Papas','Papas','2018-05-01 00:00:00',1200,1,'Peso colombiano','$','COP'),(5,5,'Nuevo','dfdfdf','2018-05-23 00:00:00',10,2,'Dólar estadounidense','$','USD');
...
-- Dump completed on 2018-05-18  0:26:43
